...
export const GrowthChart = ({
    ...
    const trackedEntityGender = GenderCodes[trackedEntity?.gender];
    const [gender, setGender] = useState<keyof typeof GenderCodes>(trackedEntityGender !== undefined ? trackedEntityGender : GenderCodes.CGC_Female);
    ...
    useEffect(() => {
        Object.keys(GenderCodes).includes(trackedEntity.gender) && setGender(GenderCodes[trackedEntity?.gender]);
    }, [trackedEntity]);
